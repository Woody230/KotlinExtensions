import com.bselzer.ktx.serialization.context.XmlContext
...
class EnumTests {
    ...
    fun map_StringToEnum() {
        ...
        // Act
        val output1 = with(XmlContext) { map1.decodeKeysOrEmpty<TestEnum, Int>() }
        val output2 = with(XmlContext) { map2.decodeKeysOrEmpty<TestEnum, String>() }
