...
public abstract class WidgetRun implements Dependency {
    ...
    public int orientation = ConstraintWidget.HORIZONTAL;
    ...
    protected void updateRunCenter(Dependency dependency, ConstraintAnchor startAnchor, ConstraintAnchor endAnchor, int orientation) {
        ...
        float bias = orientation == ConstraintWidget.HORIZONTAL ? widget.getHorizontalBiasPercent()
        ...
        switch (matchConstraintsType) {
            ...
            case ConstraintWidget.MATCH_CONSTRAINT_PERCENT: {
                ...
                if (parent != null) {
                    ...
                    if (run.dimension.resolved) {
                        float percent = orientation == ConstraintWidget.HORIZONTAL ?
            ...
            case ConstraintWidget.MATCH_CONSTRAINT_RATIO: {
                if (widget.horizontalRun.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT
                        && widget.horizontalRun.matchConstraintsType == ConstraintWidget.MATCH_CONSTRAINT_RATIO
                        && widget.verticalRun.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT
                        && widget.verticalRun.matchConstraintsType == ConstraintWidget.MATCH_CONSTRAINT_RATIO) {
                    // pof
                } else {
                    WidgetRun run = (orientation == ConstraintWidget.HORIZONTAL) ? widget.verticalRun : widget.horizontalRun;
                    if (run.dimension.resolved) {
