...
public class BasicMeasure {
    ...
    private void measureChildren(ConstraintWidgetContainer layout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            ConstraintWidget.DimensionBehaviour widthBehavior = child.getDimensionBehaviour(ConstraintWidget.HORIZONTAL);
            ConstraintWidget.DimensionBehaviour heightBehavior = child.getDimensionBehaviour(ConstraintWidget.VERTICAL);
