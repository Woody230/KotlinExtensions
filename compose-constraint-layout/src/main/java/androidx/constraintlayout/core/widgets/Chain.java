...
public class Chain {
    ...
    static void applyChainConstraints(ConstraintWidgetContainer container, LinearSystem system,
        ...
        while (!done) {
            ...
            boolean isSpreadOnly = widget.mListDimensionBehaviors[orientation] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT
        ...
        if (lastVisibleWidget != null && last.mListAnchors[offset + 1].mTarget != null) {
            ...
            boolean isSpreadOnly = lastVisibleWidget.mListDimensionBehaviors[orientation] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT
