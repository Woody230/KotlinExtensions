...
public class DependencyGraph {
    ...
    public boolean directMeasure(boolean optimizeWrap) {
        ...
        ConstraintWidget.DimensionBehaviour originalHorizontalDimension = container.getDimensionBehaviour(ConstraintWidget.HORIZONTAL);
        ConstraintWidget.DimensionBehaviour originalVerticalDimension = container.getDimensionBehaviour(ConstraintWidget.VERTICAL);
        ...
        if (originalHorizontalDimension == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || originalVerticalDimension == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            if (optimizeWrap && originalHorizontalDimension == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                ...
                container.setWidth(computeWrap(container, ConstraintWidget.HORIZONTAL));
            ...
            if (optimizeWrap && originalVerticalDimension == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                ...
                container.setHeight(computeWrap(container, ConstraintWidget.VERTICAL));
        ...
        if (container.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL] == ConstraintWidget.DimensionBehaviour.FIXED
                || container.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            ...
            measureWidgets();
            if (container.mListDimensionBehaviors[ConstraintWidget.VERTICAL] == ConstraintWidget.DimensionBehaviour.FIXED
                    || container.mListDimensionBehaviors[ConstraintWidget.VERTICAL] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
    ...
    private boolean basicMeasureWidgets(ConstraintWidgetContainer constraintWidgetContainer) {
        for (ConstraintWidget widget : constraintWidgetContainer.mChildren) {
            ConstraintWidget.DimensionBehaviour horizontal = widget.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL];
            ConstraintWidget.DimensionBehaviour vertical = widget.mListDimensionBehaviors[ConstraintWidget.VERTICAL];
            ...
            if (horizontal == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && widget.mMatchConstraintDefaultWidth == ConstraintWidget.MATCH_CONSTRAINT_WRAP) {
                if (widget.mLeft.mTarget == null || widget.mRight.mTarget == null) {
                    horizontal = ConstraintWidget.DimensionBehaviour.WRAP_CONTENT;
                }
            }
            if (vertical == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && widget.mMatchConstraintDefaultHeight == ConstraintWidget.MATCH_CONSTRAINT_WRAP) {
            ...
            if (horizontal == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (vertical == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || vertical == ConstraintWidget.DimensionBehaviour.FIXED)) {
                if (widget.mMatchConstraintDefaultWidth == ConstraintWidget.MATCH_CONSTRAINT_RATIO) {
                    ...
                    measure(widget, ConstraintWidget.DimensionBehaviour.FIXED, width, ConstraintWidget.DimensionBehaviour.FIXED, height);
                    widget.horizontalRun.dimension.resolve(widget.getWidth());
                    widget.verticalRun.dimension.resolve(widget.getHeight());
                    widget.measured = true;
                    continue;
                    ...
                    if (constraintWidgetContainer.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL] == ConstraintWidget.DimensionBehaviour.FIXED
                            || constraintWidgetContainer.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            ...
            if (vertical == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && (horizontal == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || horizontal == ConstraintWidget.DimensionBehaviour.FIXED)) {
                if (widget.mMatchConstraintDefaultHeight == ConstraintWidget.MATCH_CONSTRAINT_RATIO) {
                    ...
                    if (constraintWidgetContainer.mListDimensionBehaviors[ConstraintWidget.VERTICAL] == ConstraintWidget.DimensionBehaviour.FIXED
                            || constraintWidgetContainer.mListDimensionBehaviors[ConstraintWidget.VERTICAL] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            ...
            if (horizontal == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && vertical == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                if (widget.mMatchConstraintDefaultWidth == ConstraintWidget.MATCH_CONSTRAINT_WRAP
                    ...
                    widget.verticalRun.dimension.wrapValue = widget.getHeight();
                        ...
                        && widget.mMatchConstraintDefaultWidth == ConstraintWidget.MATCH_CONSTRAINT_PERCENT
                        && constraintWidgetContainer.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL] == ConstraintWidget.DimensionBehaviour.FIXED
                        && constraintWidgetContainer.mListDimensionBehaviors[ConstraintWidget.VERTICAL] == ConstraintWidget.DimensionBehaviour.FIXED) {
    ...
    public void measureWidgets() {
        for (ConstraintWidget widget : container.mChildren) {
            ...
            ConstraintWidget.DimensionBehaviour horiz = widget.mListDimensionBehaviors[ConstraintWidget.HORIZONTAL];
            ConstraintWidget.DimensionBehaviour vert = widget.mListDimensionBehaviors[ConstraintWidget.VERTICAL];
            ...
            boolean horizWrap = horiz == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT
                    || (horiz == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && horizMatchConstraintsType == ConstraintWidget.MATCH_CONSTRAINT_WRAP);

            boolean vertWrap = vert == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT
                    || (vert == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && vertMatchConstraintsType == ConstraintWidget.MATCH_CONSTRAINT_WRAP);
            ...
            if (horizResolved && vertResolved) {
                measure(widget, ConstraintWidget.DimensionBehaviour.FIXED, widget.horizontalRun.dimension.value,
                        ConstraintWidget.DimensionBehaviour.FIXED, widget.verticalRun.dimension.value);
                widget.measured = true;
            } else if (horizResolved && vertWrap) {
                measure(widget, ConstraintWidget.DimensionBehaviour.FIXED, widget.horizontalRun.dimension.value,
                        ConstraintWidget.DimensionBehaviour.WRAP_CONTENT, widget.verticalRun.dimension.value);
                ...
                measure(widget, ConstraintWidget.DimensionBehaviour.WRAP_CONTENT, widget.horizontalRun.dimension.value,
                        ConstraintWidget.DimensionBehaviour.FIXED, widget.verticalRun.dimension.value);
    ...
    public void buildGraph() {
        ...
        if (USE_GROUPS) {
            ...
            RunGroup.index = 0;
            findGroup(container.horizontalRun, ConstraintWidget.HORIZONTAL, mGroups);
            findGroup(container.verticalRun, ConstraintWidget.VERTICAL, mGroups);
        }
...
//        }
    ...
    private String nodeDefinition(WidgetRun run) {
        int orientation = run instanceof VerticalWidgetRun ? ConstraintWidget.VERTICAL : ConstraintWidget.HORIZONTAL;
        String name = run.widget.getDebugName();
        StringBuilder definition = new StringBuilder(name);
        ConstraintWidget.DimensionBehaviour behaviour = orientation == ConstraintWidget.HORIZONTAL ? run.widget.getHorizontalDimensionBehaviour()
    ...
    private String generateDisplayGraph(WidgetRun root, String content) {
        ...
        if (root instanceof HorizontalWidgetRun
                || (root instanceof ChainRun && ((ChainRun) root).orientation == ConstraintWidget.HORIZONTAL)) {
            ...
            if (behaviour == ConstraintWidget.DimensionBehaviour.FIXED
                ...
                if (behaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && root.widget.getDimensionRatio() > 0) {
                    sb.append("\n");
                ...
                || (root instanceof ChainRun && ((ChainRun) root).orientation == ConstraintWidget.VERTICAL)) {
