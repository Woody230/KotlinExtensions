...
class RunGroup {
    ...
    public long computeWrapSize(ConstraintWidgetContainer container, int orientation) {
        ...
        DependencyNode containerStart = orientation == ConstraintWidget.HORIZONTAL ? container.horizontalRun.start : container.verticalRun.start;
        DependencyNode containerEnd = orientation == ConstraintWidget.HORIZONTAL ? container.horizontalRun.end : container.verticalRun.end;
    ...
    public void defineTerminalWidgets(boolean horizontalCheck, boolean verticalCheck) {
        if (horizontalCheck && firstRun instanceof HorizontalWidgetRun) {
            defineTerminalWidget(firstRun, ConstraintWidget.HORIZONTAL);
        }
        if (verticalCheck && firstRun instanceof VerticalWidgetRun) {
            defineTerminalWidget(firstRun, ConstraintWidget.VERTICAL);
        }
    }
}
