...
class LinearEquation {
    ...
    private fun simplifySide(side: ArrayList<EquationVariable?>) {
        ...
        val variables = HashMap<String?, EquationVariable?>()
        val variablesNames = ArrayList<String>()
        run {
            var i = 0
     ...
     */
    private fun replace(v: SolverVariable, l: LinearEquation, list: ArrayList<EquationVariable?>) {
     ...
     */
    private fun find(v: SolverVariable, list: ArrayList<EquationVariable?>): EquationVariable? {
        var i = 0
        val listSize = list.size
        while (i < listSize) {
            val ev = list[i]!!
