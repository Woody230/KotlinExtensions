 ...
 */
class EnumSetting<E : Enum<E>>(settings: Settings, key: String, defaultValue: E, private val serializer: KSerializer<E>) : SettingWrapper<E>(settings, key, defaultValue) {
