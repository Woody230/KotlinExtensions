...
fun <T> SingleChoiceDialog(
    ...
    buttonStyle: ButtonStyle = LocalButtonStyle.localized(),
    buttonTextStyle: WordStyle = LocalWordStyle.localized(),
    radioButtonStyle: RadioButtonStyle = LocalRadioButtonStyle.localized(),
    labelStyle: WordStyle = LocalWordStyle.localized(),
    columnStyle: LazyColumnStyle = LocalLazyColumnStyle.localized(),
    values: List<T>,
    labels: List<String>,
    selected: T?,
    onStateChanged: (T) -> Unit,
