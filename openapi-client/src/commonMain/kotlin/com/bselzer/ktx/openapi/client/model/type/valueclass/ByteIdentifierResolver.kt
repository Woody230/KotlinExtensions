...
object ByteIdentifierResolver : IdentifierResolver() {
    override val value: ClassName = ClassName.BYTE
    ...
    override val identifier: ClassName = ClassName.BYTE_IDENTIFIER
