...
data class BottomAppBarPresentation(
    /**
...
) : Presenter<BottomAppBarPresentation>() {
    companion object {
        @Stable
        val Default = BottomAppBarPresentation()
    }

    override fun safeMerge(other: BottomAppBarPresentation) = BottomAppBarPresentation(
    ...
    @Composable
    override fun localized() = BottomAppBarPresentation(
