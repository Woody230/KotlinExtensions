...
class SpacerProjection(
    override val logic: SpacerLogic,
    override val presentation: SpacerPresentation = SpacerPresentation.Default
) : Projector<SpacerLogic, SpacerPresentation>() {
    @Composable
    fun project(
