...
inline fun MotionLayout(
    ...
    transition: com.bselzer.ktx.constraintlayout.compose.Transition? = null,
    progress: Float,
...
internal inline fun MotionLayoutCore(
    ...
    val transition: com.bselzer.ktx.constraintlayout.compose.Transition? =
...
@Composable
fun Transition(content: String): com.bselzer.ktx.constraintlayout.compose.Transition? {
    val transition = remember(content) {
        ...
        mutableStateOf(
            if (parsed != null) {
                object : com.bselzer.ktx.constraintlayout.compose.Transition {
...
internal fun rememberMotionLayoutMeasurePolicy(
    ...
    transition: com.bselzer.ktx.constraintlayout.compose.Transition?,
