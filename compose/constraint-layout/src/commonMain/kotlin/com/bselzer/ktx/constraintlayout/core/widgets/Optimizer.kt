...
object Optimizer {
    ...
    const val OPTIMIZATION_STANDARD = (OPTIMIZATION_DIRECT /* | OPTIMIZATION_GROUPING */ /* | OPTIMIZATION_DEPENDENCY_ORDERING */
            or OPTIMIZATION_CACHE_MEASURES /* | OPTIMIZATION_GRAPH */ /* | OPTIMIZATION_GRAPH_WRAP */ /* | OPTIMIZATION_DIMENSIONS */)

    // Internal use.
    var flags = BooleanArray(3)
     ...
     * @param widget
     */
    fun checkMatchParent(container: ConstraintWidgetContainer, system: LinearSystem, widget: ConstraintWidget) {
        ...
        if (container.mListDimensionBehaviors[ConstraintWidget.DIMENSION_VERTICAL] !== DimensionBehaviour.WRAP_CONTENT
            ...
            if (widget.mBaselineDistance > 0 || widget.visibility == ConstraintWidget.GONE) {
                ...
                system.addEquality(widget.mBaseline!!.solverVariable, top + widget.mBaselineDistance)
            }
