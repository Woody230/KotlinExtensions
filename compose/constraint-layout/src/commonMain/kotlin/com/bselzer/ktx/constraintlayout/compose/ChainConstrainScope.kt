...
private class ChainVerticalAnchorable constructor(
    ...
    override fun getConstraintReference(state: State): ConstraintReference =
        state.helper(id, com.bselzer.ktx.constraintlayout.core.state.State.Helper.HORIZONTAL_CHAIN)
}
...
private class ChainHorizontalAnchorable constructor(
    ...
    override fun getConstraintReference(state: State): ConstraintReference =
        state.helper(id, com.bselzer.ktx.constraintlayout.core.state.State.Helper.VERTICAL_CHAIN)
}