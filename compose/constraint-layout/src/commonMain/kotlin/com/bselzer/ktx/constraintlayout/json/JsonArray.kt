 ...
 */
package com.bselzer.ktx.constraintlayout.json

import com.bselzer.ktx.constraintlayout.json.Json.checkDouble
import com.bselzer.ktx.constraintlayout.json.Json.toBoolean
import com.bselzer.ktx.constraintlayout.json.Json.toDouble
import com.bselzer.ktx.constraintlayout.json.Json.toInteger
import com.bselzer.ktx.constraintlayout.json.Json.toLong
import com.bselzer.ktx.constraintlayout.json.Json.typeMismatch
 ...
 * Booleans, Integers, Longs, Doubles, `null` or [JsonObject.Companion.NULL].
 ...
 * ways: the standard Java `null` reference, and the sentinel value [ ][JsonObject.Companion.NULL]. In particular, `get` fails if the requested index
...
class JsonArray {
     ...
     * Integer, Long, Double, [JsonObject.Companion.NULL], or `null`. May
     ...
     * is the `null` reference or [JsonObject.Companion.NULL].
     */
