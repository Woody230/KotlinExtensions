 ...
 */
package com.bselzer.ktx.constraintlayout.core.widgets
...
import com.bselzer.ktx.constraintlayout.core.state.WidgetFrame
import com.bselzer.ktx.constraintlayout.core.widgets.analyzer.ChainRun
import com.bselzer.ktx.constraintlayout.core.widgets.analyzer.HorizontalWidgetRun
import com.bselzer.ktx.constraintlayout.core.widgets.analyzer.VerticalWidgetRun
import com.bselzer.ktx.constraintlayout.core.widgets.analyzer.WidgetRun
import com.bselzer.ktx.constraintlayout.utility.Utils.radians
...
open class ConstraintWidget {
     ...
     */
    var anchors = ArrayList<ConstraintAnchor?>()
        protected set
    ...
    fun addChildrenToSolverByDependency(container: ConstraintWidgetContainer, system: LinearSystem, widgets: HashSet<ConstraintWidget?>, orientation: Int, addSelf: Boolean) {
        if (addSelf) {
