...
import com.bselzer.ktx.constraintlayout.compose.State
...
abstract class ConstraintLayoutBaseScope {
    ...
    fun createHorizontalChain(
        ...
        tasks.add { state ->
            val helper = state.helper(
                id,
                com.bselzer.ktx.constraintlayout.core.state.State.Helper.HORIZONTAL_CHAIN
            ) as com.bselzer.ktx.constraintlayout.core.state.helpers.HorizontalChainReference
    ...
    fun createVerticalChain(
        ...
        tasks.add { state ->
            val helper = state.helper(
                id,
                com.bselzer.ktx.constraintlayout.core.state.State.Helper.VERTICAL_CHAIN
            ) as com.bselzer.ktx.constraintlayout.core.state.helpers.VerticalChainReference
            helper.add(*(elements.map { it.id }.toTypedArray()))
            helper.style(chainStyle.style)
            helper.apply()
            if (chainStyle.bias != null) {
...
class ChainStyle internal constructor(
    internal val style: com.bselzer.ktx.constraintlayout.compose.SolverChain,
